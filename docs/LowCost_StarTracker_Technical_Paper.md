...
|:-----------------:|:-----------------------:|
| ![Harrier camera front view with 10x zoom lens mounted on Orange Cube](images/hardware_setup_front.jpg) | ![Rear view showing Active Silicon AS-CIB-USBHDMI board and ProfiCNC/HEX Orange Cube](images/hardware_setup_rear.jpg) |
